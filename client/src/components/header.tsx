...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-border">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="text-sm font-medium bg-accent text-accent-foreground px-2 py-1 rounded">
              01
            </div>
          </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`mobile-menu fixed top-0 left-0 w-full h-screen bg-background z-50 md:hidden ${isMobileMenuOpen ? "open" : ""}`}
      >

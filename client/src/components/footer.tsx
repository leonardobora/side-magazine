    ...
    <footer id="contato" className="bg-foreground text-background py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center md:text-left">
          ...
          {/* Contact */}
          <div className="fade-in-up">
            <h3 className="font-bold mb-4" data-testid="footer-contact-title">
              CONTATO
            </h3>
          ...
          {/* Credits */}
          <div className="fade-in-up">
            <h3 className="font-bold mb-4" data-testid="footer-credits-title">
              CRÉDITOS
            </h3>
            <p className="text-sm opacity-80" data-testid="footer-team">
              Equipe SIDE Magazine
            </p>
            <p
